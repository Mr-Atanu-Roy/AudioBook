...
IFontDisp = Font
__all__ = [ 'FONTSTRIKETHROUGH', 'StdPicture', 'Default',
           'IPictureDisp', 'OLE_YSIZE_CONTAINER', 'Gray', 'FONTSIZE',
           'OLE_XPOS_HIMETRIC', 'OLE_XSIZE_CONTAINER', 'OLE_TRISTATE',
           'FONTBOLD', 'IPicture', 'OLE_COLOR', 'Color',
           'OLE_YSIZE_HIMETRIC', 'OLE_XPOS_PIXELS',
           'OLE_XSIZE_HIMETRIC', 'OLE_YPOS_HIMETRIC', 'OLE_HANDLE',
           'IFontEventsDisp', 'StdFont', 'Font', 'FONTITALIC',
           'IFontDisp', 'OLE_OPTEXCLUSIVE', 'Unchecked', 'Picture',
           'Checked', 'OLE_YPOS_CONTAINER', 'FontEvents',
           'OLE_XSIZE_PIXELS', 'FONTUNDERSCORE', 'OLE_CANCELBOOL',
           'FONTNAME', 'OLE_XPOS_CONTAINER', 'OLE_YSIZE_PIXELS',
           'VgaColor', 'OLE_ENABLEDEFAULTBOOL', 'Monochrome',
           'OLE_YPOS_PIXELS', 'IFont', 'LoadPictureConstants']
from comtypes import _check_version; _check_version('', 1247529555.877464)
